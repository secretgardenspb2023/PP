    ...
    <div className="container-page max-w-3xl py-10">
      <article className="space-y-6 text-[16px] leading-relaxed text-accent-ink">
        ...
        <section>
          ...
          <ul className="list-disc space-y-2 pl-5">
            ...
            <li>
              ...
              поведении на сайте. Используются по умолчанию; вы можете отказаться через баннер
              или ссылку «Настройки cookie» в подвале сайта.
            </li>
          </ul>
        </section>
        ...
        <section>
          ...
          <p>
            При первом посещении сайт показывает информационный баннер об использовании
            cookie и аналитики. Продолжая пользоваться сайтом, вы соглашаетесь с их
            использованием. Если вы нажмёте «Отклонить», Яндекс.Метрика отключается.
          </p>
        </section>
